...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(m2m_table_name, (
            ...
            ('tag', models.ForeignKey(orm[u'cultura.tag'], null=False))
        ))
        db.create_unique(m2m_table_name, ['post_id', 'tag_id'])

        # Adding model 'Tag'
        db.create_table(u'cultura_tag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'cultura', ['Tag'])
    ...
    models = {
        u'cultura.post': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['cultura.Tag']", 'null': 'True', 'blank': 'True'}),
